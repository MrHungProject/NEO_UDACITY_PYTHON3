...
def write_to_csv(results, filename):
    ...
    with open(filename, 'w') as save_file_csv:
        writer = csv.writer(save_file_csv)
    with open(filename, 'w') as save_file_csv:
        writer = csv.writer(save_file_csv)
...
def write_to_json(results, filename):
    ...
    for approach in results:
        ...
        data_map.append(listdata)
    with open(filename, 'w') as saved_file_json:
        json.dump(data_map, saved_file_json)